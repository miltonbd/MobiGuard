 ...
 */
public class VideoRecordAdapter extends  RecyclerView.Adapter<VideoRecordAdapter.DataObjectHolder> {
    private int resource;
    private Context context;
    public List<VideoRecordPojo> items = new ArrayList<VideoRecordPojo>();
    ...
    public static void setMyClickListener(MyEventListener myClickListener) {
        VideoRecordAdapter.myClickListener = myClickListener;
    }

    public VideoRecordAdapter(List<VideoRecordPojo> items, int resource) {
    ...
    public void onBindViewHolder(DataObjectHolder holder, int position) {
        VideoRecordPojo item = items.get(position);
    ...
    public void addItem(VideoRecordPojo dataObj, int index) {
        items.add(dataObj);
    ...
    public VideoRecordPojo getItem(int position) {
