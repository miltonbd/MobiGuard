 ...
 */
public class AudioRecordAdapter extends  RecyclerView.Adapter<AudioRecordAdapter.DataObjectHolder> {
    private int resource;
    private Context context;
    public List<AudioRecordPojo> items = new ArrayList<AudioRecordPojo>();
    ...
    public static void setMyClickListener(MyEventListener myClickListener) {
        AudioRecordAdapter.myClickListener = myClickListener;
    }

    public AudioRecordAdapter(List<AudioRecordPojo> items, int resource) {
    ...
    public void onBindViewHolder(DataObjectHolder holder, int position) {
        AudioRecordPojo item = items.get(position);
    ...
    public void addItem(AudioRecordPojo dataObj, int index) {
        items.add(dataObj);
    ...
    public AudioRecordPojo getItem(int position) {
