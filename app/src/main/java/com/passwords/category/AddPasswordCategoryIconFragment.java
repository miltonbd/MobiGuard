 ...
 * Use the {@link AddPasswordCategoryIconFragment#newInstance} factory method to
 * create an instance of this fragment3.
 */
public class AddPasswordCategoryIconFragment extends DialogFragment {
    ...
    public AddPasswordCategoryIconFragment() {
    }

    public static AddPasswordCategoryIconFragment newInstance() {
        AddPasswordCategoryIconFragment fragment = new AddPasswordCategoryIconFragment();
        return fragment;
    }
    ...
    public void onIconClicked(int position) {
        ...
        EventBus.getDefault().post(new OnAddCategoryIconSelected(icon));
        getDialog().cancel();
    }
