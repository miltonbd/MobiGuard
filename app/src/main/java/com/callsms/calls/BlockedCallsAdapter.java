...
public class BlockedCallsAdapter extends  RecyclerView.Adapter<BlockedCallsAdapter.DataObjectHolder> {
    private int resource;
    private Context context;
    public List<BlockedCalls> items = new ArrayList<BlockedCalls>();
    ...
    public static void setMyClickListener(MyEventListener myClickListener) {
        BlockedCallsAdapter.myClickListener = myClickListener;
    }

    public BlockedCallsAdapter(List<BlockedCalls> items, int resource) {
    ...
    public void onBindViewHolder(DataObjectHolder holder, int position) {
        BlockedCalls item = items.get(position);
    ...
    public void addItem(BlockedCalls dataObj, int index) {
        items.add(dataObj);
    ...
    public BlockedCalls getItem(int position) {
