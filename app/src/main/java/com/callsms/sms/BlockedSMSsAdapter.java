...
public class BlockedSMSsAdapter extends  RecyclerView.Adapter<BlockedSMSsAdapter.DataObjectHolder> {
    private int resource;
    private Context context;
    public List<BlockedSMS> items = new ArrayList<BlockedSMS>();
    ...
    public static void setMyClickListener(MyEventListener myClickListener) {
        BlockedSMSsAdapter.myClickListener = myClickListener;
    }

    public BlockedSMSsAdapter(List<BlockedSMS> items, int resource) {
    ...
    public void onBindViewHolder(DataObjectHolder holder, int position) {
        BlockedSMS item = items.get(position);
        ...
        holder.textViewSMS.setText(item.getSms());
    }
    ...
    public void addItem(BlockedSMS dataObj, int index) {
        items.add(dataObj);
